                ...
                new Message("system", """
                    {
                      ...
                      7. 만약 사용자가 말한 요청이 장소 추천에 맞지 않는다면 모든 데이터를 null로 하고 title에 잘못된 입력이라는 값을 넣으세요
                      8. 주소는 반드시 정확히 작성해주시고 지명만이 아닌 도로명 주소로 표시하며 자세히 적어주세요(ex : 충청남도 천안시 서북구 입장면 하장4길 39-7).
                      9. 이미 없어진 가게일 수 있으니 검증을 하고 적어주세요.
                      10. route summary는 2줄정도 설명을 해주세요
                      ""\"
                    }
                        """),
